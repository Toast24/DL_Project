...
Usage:
  python run_ablation_matrix.py --config configs/default.yaml --data_root data/cable_resplit/cable --output_root outputs/ablation_m1 --epochs 3
"""
...
def main():
    ...
    parser.add_argument("--output_root", type=str, default="outputs/ablation_matrix")
